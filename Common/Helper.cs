...
namespace ReflectionWpf
{
    public static class ReflectionHelper
    {
        ...
        public static Tuple<Type, MemberInfo>[] GetMethodsByAttribute(System.Reflection.Assembly assembly, System.Type type)

            => assembly.GetTypes()
                .SelectMany(t => t.GetMethods().Select(_ => Tuple.Create(t, (MemberInfo)_)))
                .Where(_ => _.Item2.IsDefined(type))
                .ToArray();

        public static Tuple<Type, MemberInfo>[] GetPropertiesByAttribute(System.Reflection.Assembly assembly, System.Type type)

            => assembly.GetTypes()
                .SelectMany(t => t.GetProperties().Select(_ => Tuple.Create(t, (MemberInfo)_)))
                .Where(_ => _.Item2.IsDefined(type))
                .ToArray();
